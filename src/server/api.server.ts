...
export default (io: RootNS, replicator: Replicator, extensions: { [k: string]: unknown }, mount: Middleware) => {
 ...
 * @returns {Function}
 */
function _wrapAcknowledgement<T extends (...args: any[]) => any>(ack: T): T {
	let handled = false;
