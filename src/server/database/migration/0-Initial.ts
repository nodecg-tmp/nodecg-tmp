...
export class Initial0 implements MigrationInterface {
	async up(queryRunner: QueryRunner): Promise<void> {
		await queryRunner.query('INSERT INTO role (id, name) VALUES ("$1", "superuser");', [ROLE_ID]);
		await queryRunner.query(
			'INSERT INTO permission (id, roleId, entityId, actions) VALUES ("$1", "$2", "*", $3);',
			[PERMISSION_ID, ROLE_ID, Action.READ | Action.WRITE],
		);
	}
