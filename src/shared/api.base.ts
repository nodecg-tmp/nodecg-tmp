...
type ListenFunc = (data: unknown, ack?: (err: any, response: unknown) => void) => void;
...
export abstract class NodeCGAPIBase {
	 ...
	 * });
	 */
	static waitForReplicants(...replicants: AbstractReplicant<any>[]): Promise<void> {
	...
	listenFor(messageName: string, bundleNameOrHandlerFunc: string | ListenFunc, handlerFunc?: ListenFunc) {
